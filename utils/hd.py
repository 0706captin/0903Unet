...
def Hausdorff_distance(i, image_root, gt_root, pred_root, name, date):
    ...
    save_dir = '/home/huangjq/PycharmCode/cxj_Code/B4_attUnetv4/results/images/0903v1/k0/contours'
...
def save_hd_contours(k, date):
    # root = '/home/huangjq/PyCharmCode/4_project/1_UNet/B4_attUnetv4/results/images'
    root = '/home/huangjq/PycharmCode/cxj_Code/B4_attUnetv4/results/images'
...
if __name__ == '__main__':
    hd_list, name = save_hd_contours(k=0, date='0903v1')
