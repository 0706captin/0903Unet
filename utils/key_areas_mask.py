...
def save_key_areas_mask(image_root, gt_root, pred_root, name):
    ...
    for each_conts in areas:
        if each_conts > 9000:
            ...
            contours_p = Leave_target(contours_pre)
            contours_pre = strip(contours_p)
...
if __name__ == '__main__':
    ...
    base_root = '/home/huangjq/PycharmCode/cxj_Code/B4_attUnetv4/results/images'
